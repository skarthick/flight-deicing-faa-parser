...
import com.indmex.service.ServiceUtil;
...
public class MyProcessor implements Processor {
	...
	public void process(Exchange exchange) throws Exception {
		...
		String polygonMessages = ServiceUtil.getPolygonMessage(faaMessageJson);
		if (polygonMessages != null) {
			exchange.getIn().setBody(polygonMessages);
		}
